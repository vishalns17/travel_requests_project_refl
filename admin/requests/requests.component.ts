...
export class RequestsComponent {
  ...
  getRequests(): void {
    this.connector.listRequestsAdmin(this.sortOrder, this.fromDate, this.toDate, this.status,this.employee).subscribe(
      data => {
  ...
  navigateToRequestPage(data: any) {
    this.router.navigate(['/admin/request', data.id]);
  }
